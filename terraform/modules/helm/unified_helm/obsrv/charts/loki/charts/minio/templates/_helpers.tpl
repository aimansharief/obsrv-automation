...
{{- define "minio.root.username" -}}
  ...
  {{- else }}
    {{- include "minio.getValueFromSecret" (dict "Namespace" .Values.namespace "Name" (include "minio.fullname" .) "Length" 20 "Key" "rootUser") }}
  {{- end }}
{{- end -}}
...
{{- define "minio.root.password" -}}
  ...
  {{- else }}
    {{- include "minio.getValueFromSecret" (dict "Namespace" .Values.namespace "Name" (include "minio.fullname" .) "Length" 40 "Key" "rootPassword") }}
  {{- end }}
{{- end -}}