...
```console
tcp:
  9094: "{{ .Values.namespace }}/{{ include "kafka.fullname" . }}-0-external:9094"
  9095: "{{ .Values.namespace }}/{{ include "kafka.fullname" . }}-1-external:9094"
  9096: "{{ .Values.namespace }}/{{ include "kafka.fullname" . }}-2-external:9094"
```
  ...
  - |
    ...
    data:
      connect-standalone.properties: |-
        bootstrap.servers = {{ include "kafka.fullname" . }}-0.{{ include "kafka.fullname" . }}-headless.{{ .Values.namespace }}.svc.{{ .Values.clusterDomain }}:{{ .Values.service.port }}
        ...
      mongodb.properties: |-
